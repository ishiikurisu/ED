...
/******************************
FUNCOES DE LEITURAS DE PALAVRAS
******************************/

/*Esta funcao le uma palavra do arquivo e inclui na lista geral preliminar*/
tipo_lista* inclui_na_lista(char* aux, tipo_lista* palavr)
{
  ...
  if (palavr==NULL)
  {
    no = (tipo_lista*) malloc(sizeof(tipo_lista));
    if (no==NULL)
    {
      printf("No memory!\n");
      exit(1);
...
/*esta funcao escreve na forma padrao de saida a lista preliminar de palavras*/
...
/*esta funcao cria uma nova lista. Retorna um ponteiro vazio se nao houver espaco,
ou um ponteiro do tipo Arquivo pronto para uso*/
...
/*esta funcao abre um arquivo de texto para leitura*/
...
/*esta funcao descobre  quais arquivos deverao ser lidos pelo algoritmo*/
...
/*esta variavel guarda o numero total de palavras diferentes ja descobertas no programa*/
int global_quant = 0;

/*esta palavra conta quantas palavras existem na lista preliminar*/
...
/*esta funcao le os arquivos e adiciona as palavras a lista*/
...
/* outras funcoes de hashing e o seu melhor resultado:
...
/*esta funcao fecha os arquivos apos serem lidos*/
...
/**********************************************
GERAR DO INDICE INVERTIDO - funcao e auxiliares
***********************************************/
/*esta funcao adiciona a arvore um determinado no da lista preliminar*/
...
/*esta funcao cria a arvore de hashing para geracao do indice invertido*/
...
/*esta funcao escreve em um arquivo os dados de um no da arvore*/
...
/*esta funcao cria a lista com as palavras com suas chaves e indices
para serem imprimidos em um arquivo, a fim de serem usados mais tarde*/
...
/**************************
LEITURA DO INDICE INVERTIDO
**************************/
/*esta funcao le o arquivo produzido anteriormente e tenta reproduzir a arvore que
deu origem ao arquivo baseando-se em seus indices e na funcao de hashing escolhida*/
...
/*esta funcao faz o hashing das palavras nos arquivos*/
...
/*esta funcao gera um hashing para cada palavras*/
...
/*esta funcao escreve na saida padrao os resultados das funcoes de hashing*/
...
**********************/
/*as proximas duas funcoes mostram as estatisticas das funcoes espalhamento*/
...
/*esta funcao faz as perguntas necessarias para que o usuario interaja
com o programa e mostra os resultados pesquisados*/
